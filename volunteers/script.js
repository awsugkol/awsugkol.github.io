document.addEventListener("DOMContentLoaded", () => {
  ...
  async function handleUnlock() {
    ...
    setTimeout(async () => {
      ...
      const decryptedJS = window.ENCRYPTED_LOGIC ? await decrypt(window.ENCRYPTED_LOGIC, password) : '';
      
      if (decryptedHTML && decryptedHTML.includes("points-section") && decryptedJS) {
        ...
        // Execute decrypted JavaScript logic
        const scriptEl = document.createElement("script");
        scriptEl.textContent = decryptedJS;
